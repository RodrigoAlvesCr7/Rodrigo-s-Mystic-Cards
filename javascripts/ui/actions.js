async function getGameInfo() {
    ...
    console.log("Board2: ", resultBoard);
...
async function getBoardInfo() {
    ...
    if (!result.successful) {
        ...
        console.log("Board: ");
        console.log("Hello", GameInfo.board);
        ...
        console.log("Board: ", GameInfo.board);
    }
}
...
async function drawCardAction(deck) {
    ...
    if (result.successful) {
        ...
        GameInfo.prepareUI();
    } else alert("You can't buy more cards for now.");
}
...
async function upgradeMineAction() {
    ...
    } else alert("You can't upgrade the mine for now.");
}
