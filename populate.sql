...
# Possible end game states
  ...
  # -- Game Specific --
insert into
  rarity (rar_name, rar_cost)
values
  ("Common", 4),
  ("Epic", 6),
  ("Legendary", 12);
insert into
  user_game_card_state (ucs_state)
values
  ("Hand"),
  ("Zone"),
  ("Discarded");
insert into
  card (crd_name, crd_rarity, crd_type_id)
values
  ("Rat", 1, 1),
  ("Zombie", 1, 1),
  ("Rock", 1, 1),
  ...
  ("Dragon Breath", 3, 4);
insert into
  card_attack (ctk_attack, ctk_hp, ctk_crd_id)
values
  (2, 2, 1),
  (3, 1, 2),
  (0, 6, 3),
...
values
  ...
  (7, 17);
insert into
  card_spell (csp_attack, csp_crd_id)
values
  (1, 18),
  (2, 19),
  (3, 20),
  ...
  (8, 23);
insert into
  card_magic (cep_attack, cep_crd_id)
values
  (1, 24),
  (2, 25),
  (3, 26),
...
VALUES
  (
    1,
    'me',
    '$2b$10$Wemfac2wY/7RSCdKxuYUL.GV2clfhXC66OL76uCpDFUmpYZ/bGZtW',
    '48MnTVJ6sKIvanVHbP5Vx5rysbYrVN4EbYmk4D8xESdfm1hx8jDfNFZGNw9OZs'
  ),
  (
    2,
    'me2',
    '$2b$10$6j2xIDnnxv.TLfBSstbbO.qE7wFTf5envx/uijiFjCP3slsy7EE4K',
...
INSERT INTO
  user_game
VALUES
  (1, 1, 1, 1, 2, 15, 0, 5, 50),(2, 2, 2, 1, 1, 15, 0, 5, 50);